...
- [Configuración y Configuración Inicial](#configuración-y-configuración-inicial)
- [Optimización de Rendimiento](#optimización-de-rendimiento)
- [Organización del Código](#organización-del-código)
- [Componentes y Reutilización](#componentes-y-reutilización)
- [Diseño Responsivo](#diseño-responsivo)
- [Estados y Variantes](#estados-y-variantes)
- [Accesibilidad](#accesibilidad)
- [Migración desde v3](#migración-desde-v3)
- [Buenas Prácticas Específicas de Astro](#buenas-prácticas-específicas-de-astro)
...
<!-- Botón primario -->
<button
  class="btn bg-blue-500 text-white hover:bg-blue-600 focus:ring-2 focus:ring-blue-500"
>
  Primary
</button>
...
<!-- Botón secundario -->
<button
  class="btn bg-gray-200 text-gray-900 hover:bg-gray-300 focus:ring-2 focus:ring-gray-500"
>
  Secondary
</button>
```
...
<!-- ✅ v4 - sintaxis correcta -->
<input
  class="outline-2 focus:outline-hidden focus:ring-2 focus:ring-blue-500"
/>
...
<button
  class="bg-blue-600 text-white hover:bg-blue-700 focus:bg-blue-800 focus:ring-2 focus:ring-blue-300"
>
  Botón accesible
</button>
```
...
```html
<!-- v3 → v4 -->
shadow-sm → shadow-xs shadow → shadow-sm shadow-md → shadow-sm shadow-lg →
shadow-md shadow-xl → shadow-lg
```
...
```html
<!-- v3 → v4 -->
outline-none → outline-hidden outline-2 → outline-2
```
